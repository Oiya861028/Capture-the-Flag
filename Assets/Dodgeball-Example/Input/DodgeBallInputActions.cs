...
public partial class @DodgeBallInputActions: IInputActionCollection2, IDisposable
{
    ...
    ~@DodgeBallInputActions()
    {
        UnityEngine.Debug.Assert(!m_Player.enabled, "This will cause a leak and performance issues, DodgeBallInputActions.Player.Disable() has not been called.");
        UnityEngine.Debug.Assert(!m_UI.enabled, "This will cause a leak and performance issues, DodgeBallInputActions.UI.Disable() has not been called.");
    }
